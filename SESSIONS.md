...
## Session 36: [Player Sessions & Navigation](./prompts/SESSION_36_Player_Sessions_Navigation.md) (Upcoming)
Player session tracking, named locations, "where is everyone?", and URL-based navigation. See session file for full spec.
